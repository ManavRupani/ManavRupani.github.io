      ...
      <section className="py-24 relative">
        <div className="w-full max-w-7xl px-6 lg:px-8 mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-14">
            <div
              className="sm:col-span-2 bg-cover bg-center max-md:h-80 rounded-lg flex justify-end flex-col px-7 py-6 hover-grow"
            ...
            <div className="block hover-grow">
              <img
            ...
            <div
              className="bg-cover rounded-lg max-sm:h-80 flex justify-start flex-col px-7 py-6 hover-grow"
            ...
            <div
              className="bg-cover rounded-lg max-sm:h-80 flex justify-end flex-col px-7 py-6 hover-grow"
